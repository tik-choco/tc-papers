...
export const COPY = {
  ja: {
    ...
    study: {
      ...
      panelLabels: { collapse: '折りたたむ', expand: '開く', hide: 'パネルを隠す', dragHint: 'ドラッグで移動（上下に落とすと積む・左右の端に落とすと列を分ける）' },
  ...
  en: {
    ...
    study: {
      ...
      panelLabels: { collapse: 'Collapse', expand: 'Expand', hide: 'Hide panel', dragHint: 'Drag to move (drop on the top/bottom half to stack, on a left/right edge to split a column)' },
